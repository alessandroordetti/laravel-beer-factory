    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="mx-auto h-10 w-auto" src="{{asset('images/blue-beer.png')}}" style="height: 200px;"
                alt="Your Company">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-indigo-600">Register your
                account</h2>
        </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" name="email" type="email" autocomplete="email" placeholder="example@gmail.com" required
                            class="block w-full rounded-md border-b py-1.5 text-indigo-600 shadow-sm ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" style="line-height: normal;">
                    </div>
                </div>

                <div>
                    <div class="flex items-center justify-between">
                        <label for="password" class="block text-sm font-medium leading-6 text-indigo-600">Password</label>
                    </div>
                    <div class="mt-2">
